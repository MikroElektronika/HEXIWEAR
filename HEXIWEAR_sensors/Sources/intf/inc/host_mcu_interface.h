...
#define gHostInterface_instance                 ( FSL_UARTCOM1 )
...
typedef enum
{
    packetType_button_1         = 0,
    packetType_button_2         = 1,
    packetType_button_3         = 2,
    packetType_button_4         = 3,
    packetType_slide            = 4,
...
typedef void (*hostInterface_CallBack_t)(void*);
