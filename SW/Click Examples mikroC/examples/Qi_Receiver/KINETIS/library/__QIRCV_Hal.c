...
static T_QIRCV_GPIO_Set          fpAN;
static T_QIRCV_GPIO_Get          fpRST;
*/

#if QIRCV_SPI_CLICK == 1
/*----------------------------------------------------------------- SPI TYPES */
static T_QIRCV_SPI_Write        fpWriteSPI;
static T_QIRCV_SPI_Read         fpReadSPI;
...
/*----------------------------------------------------------------- I2C TYPES */
static T_QIRCV_I2C_Start        fpStartI2C;
static T_QIRCV_I2C_Stop         fpStopI2C;
static T_QIRCV_I2C_Restart      fpRestartI2C;
static T_QIRCV_I2C_Write        fpWriteI2C;
static T_QIRCV_I2C_Read         fpReadI2C;
...
/*---------------------------------------------------------------- UART TYPES */
static T_QIRCV_UART_Write       fpWriteUART;
static T_QIRCV_UART_Read        fpReadUART;
static T_QIRCV_UART_Ready       fpReadyUART;
