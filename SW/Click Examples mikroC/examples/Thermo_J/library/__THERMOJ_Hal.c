...
----------------------------------------------------------------------------- */
/**
@file  __THERMOJ_Hal.c
@brief   THERMOJ HAL Source
*/
/**
@page    THERMOJ_PORTING_GUIDE Thermo_J Porting Guide
...
- Under the ```#ifdef``` preprocessor write typedefs for SPI functions
  + ```T_THERMOJ_SPI_Write``` - Writes one byte - 8 clock cycles
  + ```T_THERMOJ_SPI_Read``` - Reads one byte - 8 clock cycles

#### I2C Types ####

- Add preprocessor specific for your compiler
- Under the ```#ifdef``` preprocessor write typedefs for I2C Functions
  + ```T_THERMOJ_I2C_Start```       - I2C Start
  + ```T_THERMOJ_I2C_Stop```        - I2C Stop
  + ```T_THERMOJ_I2C_Restart```     - I2C Reastart
  + ```T_THERMOJ_I2C_Write```       - Write byte
  + ```T_THERMOJ_I2C_Read```        - Read byte

#### UART Types ####

 - Add preprocessor specific for your compiler
 - Under the ```#ifdef``` preprocessor write typedefs for UART functions
  + ```T_THERMOJ_UART_Write```     - writes one byte
  + ```T_THERMOJ_UART_Read```      - reads one byte
  + ```T_THERMOJ_UART_Ready```     - checks rx buffer
*/
/* -------------------------------------------------------------------------- */
...
static T_THERMOJ_GPIO_Set          fpAN;                                  /**< Set Pin State Function Pointer */
static T_THERMOJ_GPIO_Get          fpRST;                                 /**< Get Pin State Function Pointer */
#endif

// SPI POINTERS ________________________________________________________________

#ifdef __THERMOJ_SPI
static T_THERMOJ_SPI_Write        fpWriteSPI;                             /**< Write SPI Function Pointer */
static T_THERMOJ_SPI_Read         fpReadSPI;                              /**< Read SPI Function Pointer */
#endif

// I2C POINTERS ________________________________________________________________

#ifdef __THERMOJ_I2C
static T_THERMOJ_I2C_Start        fpStartI2C;                             /**< Start I2C Function Pointer */
static T_THERMOJ_I2C_Stop         fpStopI2C;                              /**< Stop I2C Function Pointer */
static T_THERMOJ_I2C_Restart      fpRestartI2C;                           /**< Restart I2C Function Pointer */
static T_THERMOJ_I2C_Write        fpWriteI2C;                             /**< Write I2C Function Pointer */
static T_THERMOJ_I2C_Read         fpReadI2C;                              /**< Read I2C Function Pointer */
#endif

// UART POINTERS _______________________________________________________________

#ifdef __THERMOJ_UART
static T_THERMOJ_UART_Write       fpWriteUART;                            /**< Write UART Function Pointer */
static T_THERMOJ_UART_Read        fpReadUART;                             /**< Read UART Function Pointer */
static T_THERMOJ_UART_Ready       fpReadyUART;                            /**< Ready UART Function Pointer */
#endif
