...
/**
@file  __OZONE2_Hal.c
@brief   OZONE2 HAL Source
*/
/**
@page    OZONE2_PORTING_GUIDE Ozone_2 Porting Guide
...
- Under the ```#ifdef``` preprocessor write typedefs for SPI functions
  + ```T_OZONE2_SPI_Write``` - Writes one byte - 8 clock cycles
  + ```T_OZONE2_SPI_Read``` - Reads one byte - 8 clock cycles

#### I2C Types ####

- Add preprocessor specific for your compiler
- Under the ```#ifdef``` preprocessor write typedefs for I2C Functions
  + ```T_OZONE2_I2C_Start```       - I2C Start
  + ```T_OZONE2_I2C_Stop```        - I2C Stop
  + ```T_OZONE2_I2C_Restart```     - I2C Reastart
  + ```T_OZONE2_I2C_Write```       - Write byte
  + ```T_OZONE2_I2C_Read```        - Read byte

#### UART Types ####

 - Add preprocessor specific for your compiler
 - Under the ```#ifdef``` preprocessor write typedefs for UART functions
  + ```T_OZONE2_UART_Write```     - writes one byte
  + ```T_OZONE2_UART_Read```      - reads one byte
  + ```T_OZONE2_UART_Ready```     - checks rx buffer
*/
/* -------------------------------------------------------------------------- */
...
#ifdef __OZONE2_GPIO
static T_OZONE2_GPIO_Set          fpCS;                                  /**< Set Pin State Function Pointer */
static T_OZONE2_GPIO_Get          fpRDY;                                 /**< Get Pin State Function Pointer */
#endif

// SPI POINTERS ________________________________________________________________

#ifdef __OZONE2_SPI
static T_OZONE2_SPI_Write        fpWriteSPI;                             /**< Write SPI Function Pointer */
static T_OZONE2_SPI_Read         fpReadSPI;                              /**< Read SPI Function Pointer */
#endif

// I2C POINTERS ________________________________________________________________

#ifdef __OZONE2_I2C
static T_OZONE2_I2C_Start        fpStartI2C;                             /**< Start I2C Function Pointer */
static T_OZONE2_I2C_Stop         fpStopI2C;                              /**< Stop I2C Function Pointer */
static T_OZONE2_I2C_Restart      fpRestartI2C;                           /**< Restart I2C Function Pointer */
static T_OZONE2_I2C_Write        fpWriteI2C;                             /**< Write I2C Function Pointer */
static T_OZONE2_I2C_Read         fpReadI2C;                              /**< Read I2C Function Pointer */
#endif

// UART POINTERS _______________________________________________________________

#ifdef __OZONE2_UART
static T_OZONE2_UART_Write       fpWriteUART;                            /**< Write UART Function Pointer */
static T_OZONE2_UART_Read        fpReadUART;                             /**< Read UART Function Pointer */
static T_OZONE2_UART_Ready       fpReadyUART;                            /**< Ready UART Function Pointer */
#endif
