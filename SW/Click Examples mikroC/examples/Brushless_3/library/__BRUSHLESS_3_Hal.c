...
/**
@file           __BRUSHLESS_3_Hal.c
@addtogroup     BRUSHLESS_3_HAL
@{
*/
#include "stdint.h"
...
/* EXAMPLE OF GPIO POINTERS 
static T_BRUSHLESS_3_GPIO_Set          fpAN;
static T_BRUSHLESS_3_GPIO_Get          fpRST;
*/

#if BRUSHLESS_3_SPI_CLICK == 1
/*----------------------------------------------------------------- SPI TYPES */
static T_BRUSHLESS_3_SPI_Write        fpWriteSPI;
static T_BRUSHLESS_3_SPI_Read         fpReadSPI;
...
/*----------------------------------------------------------------- I2C TYPES */
static T_BRUSHLESS_3_I2C_Start        fpStartI2C;
static T_BRUSHLESS_3_I2C_Stop         fpStopI2C;
static T_BRUSHLESS_3_I2C_Restart      fpRestartI2C;
static T_BRUSHLESS_3_I2C_Write        fpWriteI2C;
static T_BRUSHLESS_3_I2C_Read         fpReadI2C;
...
/*---------------------------------------------------------------- UART TYPES */
static T_BRUSHLESS_3_UART_Write       fpWriteUART;
static T_BRUSHLESS_3_UART_Read        fpReadUART;
static T_BRUSHLESS_3_UART_Ready       fpReadyUART;
