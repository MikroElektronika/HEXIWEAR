 ...
 * Description :
 *
 *   This example initializes GNSS 5 click and GPS parser library, and displays
 *   gps data via UART click every 5 seconds.
 *   GNSS 5 click is in microbus slot 1, and USB UART click is in slot 2.
 ******************************************************************************/
