 ...
 * Description :
 *
 *   This example initializes GPS 4 click and GPS parser library, and displays
 *   gps data via USB UART every 5 seconds.
 *   GPS 4 click is in microbus slot 1.
 ******************************************************************************/
#include "__GPS_parser.h"
#define MSG( TXT ) UART0_Write_Text( TXT )
sbit GPS_RST_PIN at PTB_PDOR.B11;
sbit GPS_ON_PIN at PTB_PDOR.B2;
sbit GPS_STB_PIN at PTA_PDOR.B10;
...
static void systemInit()
{
    ...
    UART0_Init_Advanced( 115200, _UART_8_BIT_DATA, _UART_NOPARITY,
                         _UART_ONE_STOPBIT, &_GPIO_Module_UART0_PB16_17 );
...
/*
 * GPS initialization and position tracking may last up to a couple of minutes.
