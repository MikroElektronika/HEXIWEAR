...
/**
@file           __STEPPER_Hal.c
@addtogroup     STEPPER_HAL
@{
*/
#include "stdint.h"
...
@brief Internal function pointers. 

Internal pointers are needed in case we want to enable dynamic driver repamp.
This allows library driver become usable for more than one device by 
creating higher API layer which will be responible for remaping of the driver 
functions depend on peripheral used.
*/

static T_STEPPER_GPIO_Set   fpST;
static T_STEPPER_GPIO_Set   fpDIR;
static T_STEPPER_GPIO_Set   fpEN;
static T_STEPPER_GPIO_Set   fpRST;
static T_STEPPER_GPIO_Set   fpINT;

#if STEPPER_SPI_CLICK == 1
/*----------------------------------------------------------------- SPI TYPES */
static T_STEPPER_SPI_Write        fpWriteSPI;
static T_STEPPER_SPI_Read         fpReadSPI;
...
/*----------------------------------------------------------------- I2C TYPES */
static T_STEPPER_I2C_Start        fpStartI2C;
static T_STEPPER_I2C_Stop         fpStopI2C;
static T_STEPPER_I2C_Restart      fpRestartI2C;
static T_STEPPER_I2C_Write        fpWriteI2C;
static T_STEPPER_I2C_Read         fpReadI2C;
...
/*---------------------------------------------------------------- UART TYPES */
static T_STEPPER_UART_Write       fpWriteUART;
static T_STEPPER_UART_Read        fpReadUART;
static T_STEPPER_UART_Ready       fpReadyUART;
...
@note 
In case of porting to non mikroC compilers. This function should perform procedure explained
above. 
...
#elif defined( __MIKROC_PRO_FOR_8051__ ) || defined( __MIKROC_PRO_FOR_PIC32__ ) || defined( __MIKROC_PRO_FOR_PIC__ ) || defined( __MIKROC_PRO_FOR_DSPIC__ )
