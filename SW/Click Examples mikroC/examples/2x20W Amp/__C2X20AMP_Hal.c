...
----------------------------------------------------------------------------- */
/**
@file  __C2X20AMP_Hal.c
@brief   C2X20AMP HAL Source
*/
/**
@page    C2X20AMP_PORTING_GUIDE C2X20W_Amp Porting Guide
...
- Under the ```#ifdef``` preprocessor write typedefs for SPI functions
  + ```T_C2X20AMP_SPI_Write``` - Writes one byte - 8 clock cycles
  + ```T_C2X20AMP_SPI_Read``` - Reads one byte - 8 clock cycles

#### I2C Types ####

- Add preprocessor specific for your compiler
- Under the ```#ifdef``` preprocessor write typedefs for I2C Functions
  + ```T_C2X20AMP_I2C_Start```       - I2C Start
  + ```T_C2X20AMP_I2C_Stop```        - I2C Stop
  + ```T_C2X20AMP_I2C_Restart```     - I2C Reastart
  + ```T_C2X20AMP_I2C_Write```       - Write byte
  + ```T_C2X20AMP_I2C_Read```        - Read byte

#### UART Types ####

 - Add preprocessor specific for your compiler
 - Under the ```#ifdef``` preprocessor write typedefs for UART functions
  + ```T_C2X20AMP_UART_Write```     - writes one byte
  + ```T_C2X20AMP_UART_Read```      - reads one byte
  + ```T_C2X20AMP_UART_Ready```     - checks rx buffer
*/
/* -------------------------------------------------------------------------- */
...
static T_C2X20AMP_GPIO_Get          fpAD1;                                  /**< Set Pin State Function Pointer */
static T_C2X20AMP_GPIO_Get          fpAD2;                                 /**< Get Pin State Function Pointer */
static T_C2X20AMP_GPIO_Set          fpMT;
#endif

// SPI POINTERS ______________________________________

#ifdef __C2X20AMP_SPI
static T_C2X20AMP_SPI_Write        fpWriteSPI;                             /**< Write SPI Function Pointer */
static T_C2X20AMP_SPI_Read         fpReadSPI;                              /**< Read SPI Function Pointer */
#endif

// I2C POINTERS ______________________________________

#ifdef __C2X20AMP_I2C
static T_C2X20AMP_I2C_Start        fpStartI2C;                             /**< Start I2C Function Pointer */
static T_C2X20AMP_I2C_Stop         fpStopI2C;                              /**< Stop I2C Function Pointer */
static T_C2X20AMP_I2C_Restart      fpRestartI2C;                           /**< Restart I2C Function Pointer */
static T_C2X20AMP_I2C_Write        fpWriteI2C;                             /**< Write I2C Function Pointer */
static T_C2X20AMP_I2C_Read         fpReadI2C;                              /**< Read I2C Function Pointer */
#endif

// UART POINTERS _____________________________________

#ifdef __C2X20AMP_UART
static T_C2X20AMP_UART_Write       fpWriteUART;                            /**< Write UART Function Pointer */
static T_C2X20AMP_UART_Read        fpReadUART;                             /**< Read UART Function Pointer */
static T_C2X20AMP_UART_Ready       fpReadyUART;                            /**< Ready UART Function Pointer */
#endif
