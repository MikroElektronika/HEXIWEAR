...
#elif defined( __MIKROC_PRO_FOR_FT90x__ )
    soft_reset_i2c_p            = I2CM_Soft_Reset;
    set_slave_address_i2c_p     = I2CM_Set_Slave_Address;
    write_i2c_p                 = I2CM_Write_Bytes;
    read_i2c_p                  = I2CM_Read_Bytes;
#endif
