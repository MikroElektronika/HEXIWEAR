#line 1 "//VBOXSVR/storage/git/MikroE/HEXIWEAR/SW/Click Examples mikroC/2.Examples/HEXIWEAR_NFC_Click/example/ARM/RW_NDEF.c"
...
#line 1 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t1t.h"
#line 1 "c:/c4w/mikroc pro for arm/include/stdint.h"
#line 74 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t1t.h"
void rw_ndef_t1t_reset( void );
#line 83 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t1t.h"
void rw_ndef_t1t_read_next( uint8_t *p_cmd, uint16_t cmd_size,
 uint8_t *rsp, uint16_t *p_rsp_size );
#line 1 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t2t.h"
#line 1 "c:/c4w/mikroc pro for arm/include/stdint.h"
#line 75 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t2t.h"
void rw_ndef_t2t_reset( void );
#line 84 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t2t.h"
...
void rw_ndef_t3t_read_next( uint8_t *p_cmd, uint16_t cmd_size,
 uint8_t *rsp, uint16_t *p_rsp_size );
#line 1 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t4t.h"
#line 1 "c:/c4w/mikroc pro for arm/include/stdint.h"
#line 75 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t4t.h"
void rw_ndef_t4t_reset( void );
#line 84 "//vboxsvr/storage/git/mikroe/hexiwear/sw/click examples mikroc/2.examples/hexiwear_nfc_click/example/arm/rw_ndef_t4t.h"
void rw_ndef_t4t_read_next( uint8_t *p_cmd, uint16_t cmd_size,
 uint8_t *rsp, uint16_t *p_rsp_size );
#line 40 "//VBOXSVR/storage/git/MikroE/HEXIWEAR/SW/Click Examples mikroC/2.Examples/HEXIWEAR_NFC_Click/example/ARM/RW_NDEF.c"
typedef void rw_ndef_read_fct_t( uint8_t *p_cmd, uint16_t cmd_size,
 uint8_t *rsp, uint16_t *p_rsp_size );
#line 47 "//VBOXSVR/storage/git/MikroE/HEXIWEAR/SW/Click Examples mikroC/2.Examples/HEXIWEAR_NFC_Click/example/ARM/RW_NDEF.c"
uint8_t ndef_buffer[ 240 ];

static rw_ndef_read_fct_t *p_read_fct =  ((void *)0) ;

rw_ndef_callback_t *p_rw_ndef_pull_cb;
#line 60 "//VBOXSVR/storage/git/MikroE/HEXIWEAR/SW/Click Examples mikroC/2.Examples/HEXIWEAR_NFC_Click/example/ARM/RW_NDEF.c"
void rw_ndef_register_pull_callback( void *p_cb )
{
