#line 1 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
...
void rw_ndef_t3t_read_next( uint8_t *p_cmd, uint16_t cmd_size,
 uint8_t *rsp, uint16_t *p_rsp_size );
#line 57 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
static  _Bool  volatile rx_flag;
static uint32_t volatile timer_tick;
#line 63 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
...
#line 73 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
...
int nfc_reader_tag_cmd ( uint8_t *command, uint8_t commandSize,
 uint8_t *answer, uint8_t *answer_size );
#line 85 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
static int host_rx( uint8_t *p_rx_buff, uint16_t rx_buff_size,
 uint16_t *p_nbytes_read, uint16_t timeout )
{
 timer_tick = 0;
...
#line 231 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
static void p2p_mode( nfc_interface_t *rf_intf )
{
 uint8_t answer[ 258 ] = {0};
 uint16_t answer_size = 0;
...
int nfc_init( uint8_t slave_address )
{
 ...
 initialize_core();
#line 484 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
 OLED_DrawBox(0, 80, 96, 15, 0);
...
#line 565 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
 ...
 item = 0;
#line 620 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
 ...
 item = 0;
#line 659 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
 if( mode & NFC_MODE_P2P )
 {
...
#line 686 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
 if( mode & NFC_MODE_P2P )
...
void nfc_process( uint8_t mode, nfc_interface_t *rf_intf )
{
 switch ( mode )
 {
#line 826 "E:/Darko/Projekti/HEXIWEAR/Click Demo/Projekti/HEXIWEAR_NFC_Click/example/ARM/nfc.c"
 case NFC_MODE_P2P:
 p2p_mode( rf_intf );
 break;
