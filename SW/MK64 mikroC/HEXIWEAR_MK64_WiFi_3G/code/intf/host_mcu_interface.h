...
typedef enum
{
    ...
    alertIn_type_wifiSSID     = 10,
    alertIn_type_wifiPass     = 11,
    alertIn_type_wifiAuth     = 12,
    alertIn_type_mqttUsername = 13,
    alertIn_type_mqttPass     = 14,
    alertIn_type_3GName       = 15,
    alertIn_type_3GUsername   = 16,
    alertIn_type_3GPassword   = 17,
    alertIn_type_WiFiClick    = 18,
    alertIn_type_3GClick      = 19
