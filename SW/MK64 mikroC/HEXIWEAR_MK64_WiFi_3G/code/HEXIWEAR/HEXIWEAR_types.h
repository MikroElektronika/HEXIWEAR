...
typedef struct
{
    uint8_t toggledConnection;       //0 - None, 1 - WiFi, 2 - 3G
    uint8_t activeConnectionType;    //0 - None, 1 - WiFi, 2 - 3G
    uint8_t socketPosition;
    char mqtt_username[32];
    char mqtt_password[32];
    // space for additional flags
    uint8_t padding[5];
} hexiwear_connection_flags_t;
