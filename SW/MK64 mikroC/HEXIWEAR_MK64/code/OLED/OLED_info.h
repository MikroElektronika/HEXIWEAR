...
// Definitions of commonly used values in the OLED module.

#ifndef _OLED_info_h_
#define _OLED_info_h_
...
// commands 0xA2, 0xB1, 0xB3, 0xBB, 0xBE, 0xC1 are inaccessible
// in both lock and unlock state (default upon reset)
