...
//    PORTB_PCR23bits.DSE = 1;
    ...
    // set IRQ priority
    NVIC_SetIntPriority( IVT_INT_SPI2, HEXIWEAR_OLED_SPI_IRQ_PRIO );
    NVIC_SetIntPriority( IVT_INT_DMA0, HEXIWEAR_OLED_DMA_RX_IRQ_PRIO );
    NVIC_SetIntPriority( IVT_INT_DMA1, HEXIWEAR_OLED_DMA_TX_IRQ_PRIO );
