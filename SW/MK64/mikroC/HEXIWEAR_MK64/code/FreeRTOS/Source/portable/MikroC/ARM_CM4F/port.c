...
void vPortSVCHandler( void ) iv IVT_INT_SVCall ics ICS_OFF
{
        asm {
                ...
                MSR #CPU_PSP, R0                /* Restore the task stack pointer. */
                ISB
                MOV R0, #0
                MSR #CPU_BASEPRI, R0
                BX  R14
...
static void prvPortStartFirstTask( void )
{
        asm {
                ...
                LDR R0, [R0]
                LDR R0, [R0]
                MSR #CPU_MSP, R0                         /* Set the msp back to the start of the stack. */
...
void xPortPendSVHandler( void ) iv /*IVT_INT_PendSV*/ IVT_INT_PendableSrvReq ics ICS_OFF
{
        asm {
//#ifdef HW_DEBUG
 ...
 */
        ...
        void vPortSetupTimerInterrupt( void )
        {
                        ...
                        STK_CTRL = (1 << CLKSOURCE) | (1 << TICKINT) | (1 << ENABLE_);
