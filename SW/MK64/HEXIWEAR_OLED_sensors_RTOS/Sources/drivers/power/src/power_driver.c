...
power_status_t power_Init()
{
  ...
  // if ( kStatus_OSA_Success != OSA_MutexCreate( &power_mutex ) )
  // {
  //   return POWER_STATUS_ERROR;
  // }
...
/**
 * [power_StandbyInit description]
 */
void power_StandbyInit( void* param )
{
  if ( NULL == param )
  {
    power_standbyScreen.navigation.left  = &watchScreen;
    power_standbyScreen.navigation.right = &watchScreen;
    power_standbyScreen.navigation.up    = &watchScreen;
    power_standbyScreen.navigation.down  = &watchScreen;
  }

  else
  {
    power_standbyScreen.navigation.left  = (guiScreen_t*)param;
    power_standbyScreen.navigation.right = (guiScreen_t*)param;
    power_standbyScreen.navigation.up    = (guiScreen_t*)param;
    power_standbyScreen.navigation.down  = (guiScreen_t*)param;
  }

//    power_Sleep( POWER_OLED );
}
...
/**
 * [power_GetModeToEnter description]
 * @return [description]
 */
