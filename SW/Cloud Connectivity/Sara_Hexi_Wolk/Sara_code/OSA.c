...
osa_status_t OSA_MemFree( void *ptr, size_t size ) //TODO: remove size
{
    vPortFree( ptr, size );
...
{
    vTaskDelay( MSEC_TO_TICK( delay ) + 1 );
}
...
{
    return kStatus_OSA_Success; //TODO?: make an int handler installer
}
