...
#define MEASUREMENT_TIMEOUT 60000
const char SSID[] = "your_network_SSID";
const char password[] = "yor_network_psk";
const char server_addr[] = "wolksense.com";
const char port[] = "1883";
const char username_mqtt[] = "serial";
const char password_mqtt[] = "password";
const char topic[] = "sensors/serial";
