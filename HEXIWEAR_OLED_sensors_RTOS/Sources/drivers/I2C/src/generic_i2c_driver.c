                    ...
                    )
{
  switch ( self->instance )
  {
    case FSL_FS_I2C: {
                        ...
                        self->state = FS_I2C_MasterState;

                        // configure the device info
                        self->device.baudRate_kbps = FS_I2C_MasterConfig.baudRate_kbps;
                        break;
                      }

    case FSL_NFS_I2C: {
                        // assign the master structure
                        self->state = NFS_I2C_MasterState;

                        // configure the device info
                        self->device.baudRate_kbps = NFS_I2C_MasterConfig.baudRate_kbps;
                        break;
                      }
    default: {}
  }
